...
export function BusinessOwnerListPage(props: BusinessOwnerListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<BusinessOwnerInterface>>(
    () => `/business-owners?params=${JSON.stringify(params)}`,
    fetcher,
  );
  ...
  const columns: ColumnType[] = [
    { id: 'product_service_status', header: 'Product Service Status', accessorKey: 'product_service_status' },
