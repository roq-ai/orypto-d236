...
import { getDeliveryPartnerById } from 'apiSdk/delivery-partners';
import { DeliveryPartnerInterface } from 'interfaces/delivery-partner';

function DeliveryPartnerViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Delivery Status" text={data?.delivery_status} />
